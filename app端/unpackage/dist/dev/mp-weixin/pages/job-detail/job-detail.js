  ...
  methods: {
    ...
    async loadJobDetail() {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/job-detail/job-detail.vue:116", "岗位详情响应:", response);
        ...
        common_vendor.index.__f__("error", "at pages/job-detail/job-detail.vue:127", err);
    ...
    async toggleFavorite() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/job-detail/job-detail.vue:149", err);
